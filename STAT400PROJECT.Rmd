...
For the US projection, we used case counts from between February 1st and April 11th in order to obtain a sense of the projected case totals prior to many of the measures taken by local and federal governments to flatten the curve. Initial asymptote estimates were set at 700,000. The flex date algorithm was otherwise identical, with and average date calculated along with its corresponding confidence interval. 

\newpage

**Results**

The first plots show our raw data projections for Italy and the United States:
...
The plots below show the flex points of each projection for Italy and the United States:
...
Corresponding to these plots, we gathered the mean, standard deviation, and 95%, t-quantile confidence intervals for Italian and US flex points:
...
#gathering mean flex date -> 67 days from Feb 1st = April 7th
mean(na.omit(flex_mc_us)) 

#gathering standard deviation of flex dates
sd(na.omit(flex_mc_us)) 
